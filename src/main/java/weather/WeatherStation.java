...
public class WeatherStation {
    ...
    private WeatherData toWeatherData(Temperature temperature, String title) {
        return WeatherData.newBuilder()
                ...
                .withRangeMin(MIN_TEMPERATURE)
                .withRangeMax(MAX_TEMPERATURE)
                .withFirstSubRangeMin(MIN_TEMPERATURE)
                .withFirstSubRangeMax(ZERO)
                .withSecondSubRangeMin(ZERO)
                .withSecondSubRangeMax(FIFTEEN_DEGREES)
                .withThirdSubRangeMin(FIFTEEN_DEGREES)
                .withThirdSubRangeMax(MAX_TEMPERATURE)
                .build();
    }
